    ...
    <div className="edit-info-wrapper">
      ...
      <Form
        ...
        <PageHeader
          ...
          extra={[
            <Button loading={loading} key="save" type="primary" htmlType="submit" onClick={() => {
              form.submit();
            }}>保存</Button>,
          ...
          <div className="page-block" id="groupon-summary" >
            ...
            <Row gutter={20}>
              <Col span="24">
                ...
                <Form.Item labelCol={{ span: 4 }} label={$t('团购标题')} name="title" rules={[{ required: true }]}>
                ...
                <Form.Item className="moment-field" labelCol={{ span: 4 }} label={$t('售卖起止时间')} name="sale_valid_moment" rules={[{ required: true }]}>
                  <DateRangePicker
            ...
            <Row gutter={20}>
              <Col span="24">
                ...
                <Form.Item labelCol={{ span: 4 }} label={$t('单用户购买上限')} name="order_limit" rules={[{ required: true }]}>
                  <InputNumber min={1} max={99999} maxLength={5} />
                </Form.Item>
              </Col>
            </Row>
          </section>
            ...
            <Row gutter={20}>
              <Col span="24">
                ...
                {entity.valid_time_type === constants.groupon.valid_time_type.TIME_RANGE.value ?
                  <Form.Item className="moment-field" labelCol={{ span: 4 }} label={$t('券码有效时间')} name="order_valid_moment">
                    <DateRangePicker
                      showTime={{ defaultValue: [moment('00:00:00', 'HH:mm:ss'), moment('23:59:59', 'HH:mm:ss')] }}
                      format="YYYY-MM-DD HH:mm:ss"
                  ...
                  :
                  <Form.Item labelCol={{ span: 4 }} label={$t('有效天数')} name="post_purchase_day">
