...
import SearchForm, { initSearchObj } from '@/apps/btb/components/voucher/product/SearchForm';
import SearchResult from '@/apps/btb/components/voucher/product/SearchResult';
...
export default ({ }: any) => {
  ...
  return (
    <div className="btb-voucher-container table-container">
