...
var Button = /*#__PURE__*/React.forwardRef(function (_a, ref) {
  ...
  }, /*#__PURE__*/React.createElement(AntdButton, _extends({}, rest, {
    className: "".concat(rest.icon ? "".concat(getPrefixCls(), "-btn-icon") : '').concat(isDeleted ? " ".concat(getPrefixCls(), "-btn-del") : '').concat(rest.className ? " ".concat(rest.className) : ''),
    ref: ref
  })));
});
